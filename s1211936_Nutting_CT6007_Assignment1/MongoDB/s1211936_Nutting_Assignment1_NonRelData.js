...
var findResult = db.ModuleMarks.find({ "StudentID": firstDocNo });
...
var findResult = db.ModuleMarks.find({ "StudentID": middleDocNo });
...
var findResult = db.ModuleMarks.find({ "StudentID": lastDocNo });
