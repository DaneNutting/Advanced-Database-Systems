...
print("Running script to insert normalised data with an index")
...
//Insert first half of Student Data
for (i = 2; i <= middleStudentNo -1 ; i++) {
	var StudentData = {
		"Student_ID": i,
		"FirstName": "Jill " + i,
		"SurName": "Smith " + i,
...
//Insert second half of Student Data
for (i = middleStudentNo + 1 ; i <= totalStudents; i++) {
	var StudentData = {
		"Student_ID": i,
		"FirstName": "Jill " + i,
		"SurName": "Smith " + i,
...
//Insert Second half of the data
for (i = middleStudentNo + 1 ; i <= totalStudents; i++) {
	for (x = 1; x <= modulesPerStudent; x++) {
		var ModuleStudentData = {
			"Student_ID": i,
...
//Insert first half of Assignment Results and update the Module Marks in the Module Grades table
for (i = 2; i <= middleStudentNo - 1; i++) {
	CreateAssignmentMarks(i);
};

//Insert second half of Assignment Results and update the Module Marks in the Module Grades table
for (i = middleStudentNo + 1; i <= totalStudents; i++) {
	CreateAssignmentMarks(i);
};
...
db.ModuleGrades.createIndex( { "Student_ID" : 1, "Module_ID" : 1 } );
db.AssignmentMarks.createIndex( { "Student_ID" : 1, "Assignment_ID" : 1 } );

//===========================================================================================
//Insert one more student record at the beginning
//===========================================================================================

//Create an Extra Student
var FirstStudentData = {
	"Student_ID": 1,
	"FirstName": "Jill " + 1,
	"SurName": "Smith " + 1,
	"DOB": randomDOB,
...
db.Students.insert(FirstStudentData);
db.ModuleGrades.insert(ExtraModulesToAdd);
CreateAssignmentMarks(1);

var timeDiff = (new Date()).getTime() - start;

print("time required to insert an extra students data at the beginning was " + timeDiff +'ms');

//===========================================================================================
//Insert one more student record in the middle of the collection
//===========================================================================================

//Create an Extra Student
var MiddleStudentData = {
	"Student_ID": middleStudentNo,
	"FirstName": "Jill " + middleStudentNo,
	"SurName": "Smith " + middleStudentNo,
	"DOB": randomDOB,
	"Address": middleStudentNo + " Student Street",
	"Town": "Cheltenham",
	"Postcode": "GL" + Math.floor((Math.random() * 53) + 1) + " " + Math.floor((Math.random() * 9) + 1) + "AB",
	"Course"	: "Information Technology",
};
...
db.Students.insert(MiddleStudentData);
db.ModuleGrades.insert(ExtraModulesToAdd);
CreateAssignmentMarks(middleStudentNo);

var timeDiff = (new Date()).getTime() - start;

print("time required to insert an extra students data in the middle was " + timeDiff +'ms');

//===========================================================================================
//Insert one more student record at the end
//===========================================================================================
...
db.ModuleGrades.insert(ExtraModulesToAdd);
CreateAssignmentMarks((totalStudents + 1));

var timeDiff = (new Date()).getTime() - start;

print("time required to insert an extra students data at the end was " + timeDiff +'ms');
...
function showStudentMarks(studentId){
...
showStudentMarks(middleStudentNo);
...
showStudentMarks(extraStudentID);
